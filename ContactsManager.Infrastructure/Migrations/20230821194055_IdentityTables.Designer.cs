...
namespace ContactsManager.Infrastructure.Migrations
{
    ...
    [Migration("20230821194055_IdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Enttities.Country", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            CountryID = new Guid("c3681629-35c0-4078-ba94-afa7e46af34b"),
                            CountryName = "Bosnia and Herzegovina"
                        });
                });

            modelBuilder.Entity("Enttities.Person", b =>
                {
            ...
            modelBuilder.Entity("Enttities.Person", b =>
                {
                    b.HasOne("Enttities.Country", "Country")
                        .WithMany("Persons")
